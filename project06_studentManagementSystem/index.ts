...
const courses: { [courseName: string]: number } = {
    'Blockchain': 200,
...
class Student implements StudentInfo {
    ...
    constructor(stdName: string, stdEmail: string, stdAge: number, stId: number) {
...
class StudentManager {
    ...
    getStudentById(stId: number): Student | undefined {
...
async function addStudent() {
    ...
    const newStudent = new Student(
        newStudentData.stdName,
        newStudentData.stdEmail,
        newStudentData.stdAge,
...
async function enrollStudent() {
    ...
    selectedCourses.forEach((courseName: string) => student.enroll(courseName));
}
